            ...
            o = a(24), h = a.n(o), m = a(0), d = function (e) { var s = e.link, a = e.name, i = e.image, n = Object(t.useRef)(), r = Object(t.useRef)(), l = Object(t.useRef)(); return Object(m.jsxs)("a", { ref: n, onMouseEnter: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.to(l.current, { x: "2rem", duration: .5, ease: "power3.out" }), c.a.fromTo(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%" }, { scale: 1, duration: .5, ease: "power3.out" }) }, onMouseLeave: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.killTweensOf([r.current, l.current]), c.a.to(l.current, { x: 0, duration: .3, ease: "power3.out" }), c.a.to(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%", duration: .7, ease: "power3.out" }) }, href: s, target: "", children: [i && Object(m.jsx)("img", { src: i, alt: a }), Object(m.jsx)("span", { className: "link", ref: l, children: h()(a) }), Object(m.jsx)("span", { className: "overlay", ref: r })] }) }, w = a(76), g = function () {
                ...
                Object(t.useEffect)((function () { c.a.to("section", { opacity: 1, delay: 3, ease: "power3.out", duration: 2 }) }), []); return Object(m.jsxs)("div", {
                    ...
                    Object(m.jsxs)("section", {
                        children: [
                            Object(m.jsx)("h2", { children: "Unori" }),
                            Object(m.jsxs)("row", {
                                children: [
                                    Object(m.jsxs)("column", {
                                        children: [
                                            Object(m.jsx)("img", { className: "projectImg", src: "/images/Unori.webp", alt: "Unori Project Poster Descriptor" }),
                                        ]
                                    }),
                                    Object(m.jsxs)("column", {
                                        children: [
                                            Object(m.jsxs)("ul", {
                                                class: "intro", children: [
                                                    ...
                                                    Object(m.jsx)("br", {}), "Unori is an application specifically designed to assist parents of deaf children in their initial approach to sign language. Its primary goal is to enable parents to learn essential words necessary for effective communication with their child.",
                                                    Object(m.jsx)("br", {}), "However, the significance of Unori extends beyond this immediate objective. The application aims to address the potential risk of isolation that deaf children may face, particularly in terms of linguistic and communicative development. By mitigating these challenges, Unori seeks to prevent negative consequences that may impact the child's learning process, cognitive abilities, emotional well-being, and socio-relational growth.",
                                                    Object(m.jsx)("br", {}), "Within Unori, users have the option to select words from a diverse range of useful categories. By following the provided tutorials, they can learn the signs associated with each chosen word. To ensure accuracy, a machine model has been trained and integrated into the application.",
                                                    Object(m.jsx)("br", {}), "This allows users to verify if they are performing the corresponding sign correctly, thereby facilitating their learning process and ensuring accurate communication with their deaf child.",
                                                    Object(m.jsx)("br", {}), "Through the use of Unori, parents are empowered to bridge the communication gap with their deaf child at an early stage, fostering a stronger bond and facilitating the child's language development."
