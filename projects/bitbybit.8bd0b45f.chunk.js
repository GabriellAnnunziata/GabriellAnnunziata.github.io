            ...
            o = a(24), h = a.n(o), m = a(0), d = function (e) { var s = e.link, a = e.name, i = e.image, n = Object(t.useRef)(), r = Object(t.useRef)(), l = Object(t.useRef)(); return Object(m.jsxs)("a", { ref: n, onMouseEnter: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.to(l.current, { x: "2rem", duration: .5, ease: "power3.out" }), c.a.fromTo(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%" }, { scale: 1, duration: .5, ease: "power3.out" }) }, onMouseLeave: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.killTweensOf([r.current, l.current]), c.a.to(l.current, { x: 0, duration: .3, ease: "power3.out" }), c.a.to(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%", duration: .7, ease: "power3.out" }) }, href: s, target: "", children: [i && Object(m.jsx)("img", { src: i, alt: a }), Object(m.jsx)("span", { className: "link", ref: l, children: h()(a) }), Object(m.jsx)("span", { className: "overlay", ref: r })] }) }, w = a(76), g = function () {
                ...
                return Object(t.useEffect)((
                    ...
                    Object(w.a)("resize", n), Object(m.jsxs)("div", {
                        ref: e, children: [
                            Object(m.jsxs)("svg", {
                                ref: s, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 874.13 121", style: { opacity: 0 }, children: [Object(m.jsx)("title", { children: Object(m.jsx)("h1", { children: "Bit by Bit - Gabriella Annunziata" }) }), Object(m.jsxs)("g", {
                ...
                Object(t.useEffect)((function () { c.a.to("section", { opacity: 1, delay: 3, ease: "power3.out", duration: 2 }) }), []); return Object(m.jsxs)("div", {
                    ...
                    Object(m.jsxs)("section", {
                        children: [
                            Object(m.jsx)("h2", { children: "Bit By Bit" }),
                            Object(m.jsxs)("row", {
                                children: [
                                        ...
                                        children: [
                                            Object(m.jsxs)("ul", {
                                                class: "intro", children: [
                                                    Object(m.jsx)("strong", { children: "Role: Developer" }),
                                                    Object(m.jsx)("br", {}), "This project served as an experimental endeavour aimed at gaining a deeper understanding of various advanced coding topics and effectively integrating them into a single application.",
                                                    Object(m.jsx)("br", {}), "The creation of Bit by Bit, a meticulously structured guide through multiple IT fields, was not a mere coincidence.",
                                                    Object(m.jsx)("br", {}), "The app aims to provide users with different career paths within the IT industry, offering comprehensive information about job requirements and outlining the steps one can take to acquire positions in those fields.",
                                                    Object(m.jsx)("br", {}), "By exploring Bit by Bit, users can access valuable insights into various IT career paths, including detailed descriptions of the skills and qualifications necessary for each role.",
                                                    Object(m.jsx)("br", {}), "Furthermore, Bit by Bit features a dedicated library section that utilizes the Google Books API.",
                                                    Object(m.jsx)("br", {}), "This section offers an extensive collection of books related to IT, allowing users to delve deeper into specific topics of interest."
