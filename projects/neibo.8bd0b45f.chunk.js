            ...
            o = a(24), h = a.n(o), m = a(0), d = function (e) { var s = e.link, a = e.name, i = e.image, n = Object(t.useRef)(), r = Object(t.useRef)(), l = Object(t.useRef)(); return Object(m.jsxs)("a", { ref: n, onMouseEnter: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.to(l.current, { x: "2rem", duration: .5, ease: "power3.out" }), c.a.fromTo(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%" }, { scale: 1, duration: .5, ease: "power3.out" }) }, onMouseLeave: function (e) { var s = n.current.getBoundingClientRect(), a = e.clientY < s.y + s.height / 2; c.a.killTweensOf([r.current, l.current]), c.a.to(l.current, { x: 0, duration: .3, ease: "power3.out" }), c.a.to(r.current, { scaleY: 0, transformOrigin: a ? "0 0" : "0 100%", duration: .7, ease: "power3.out" }) }, href: s, target: "", children: [i && Object(m.jsx)("img", { src: i, alt: a }), Object(m.jsx)("span", { className: "link", ref: l, children: h()(a) }), Object(m.jsx)("span", { className: "overlay", ref: r })] }) }, w = a(76), g = function () {
                ...
                return Object(t.useEffect)((
                    ...
                    Object(w.a)("resize", n), Object(m.jsxs)("div", {
                        ref: e, children: [
                            Object(m.jsxs)("svg", {
                                ref: s, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 874.13 121", style: { opacity: 0 }, children: [Object(m.jsx)("title", { children: Object(m.jsx)("h1", { children: "Neibo - Gabriella Annunziata" }) }), Object(m.jsxs)("g", {
                ...
                Object(t.useEffect)((function () { c.a.to("section", { opacity: 1, delay: 3, ease: "power3.out", duration: 2 }) }), []); return Object(m.jsxs)("div", {
                    ...
                    Object(m.jsxs)("section", {
                        children: [
                            Object(m.jsx)("h2", { children: "Neibo" }),
                            Object(m.jsxs)("row", {
                                children: [
                                        ...
                                        children: [
                                            Object(m.jsxs)("ul", {
                                                class: "intro", children: [
                                                    Object(m.jsx)("strong", { children: "Role: UX Researcher" }),
                                                    Object(m.jsx)("br", {}), "Moving to a new country can pose multiple challenges along the way, which can potentially hinder the experience of adapting to a new context.",
                                                    Object(m.jsx)("br", {}), "Neibo's primary objective is to make the process of adapting to a new environment easier by connecting users with local people who can provide valuable insights and assistance.",
                                                    Object(m.jsx)("br", {}), "Through Neibo, users have the ability to post questions about any information relevant to their living situation. For instance, if you need to find a good doctor during an emergency, Neibo allows you to seek recommendations from locals who are familiar with the healthcare system in the area.",
                                                    Object(m.jsx)("br", {}), "Similarly, if you require help navigating bureaucratic processes, Neibo offers a platform to connect with individuals who can provide guidance and support. It acts as a bridge, helping users navigate the challenges of living in a new country while fostering connections and cultural exchange."
                                                ]
                                            })
                                        ]
                                    }),
